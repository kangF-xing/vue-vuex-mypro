<template>
    <dir id="groupFooter">
        <ul>
            <router-link to="" tag="li"><span class="iconfont icon-kefuweixuanzhong"></span></router-link>
            <router-link to="" tag="li"><span class="iconfont icon-shoucang"></span></router-link>
